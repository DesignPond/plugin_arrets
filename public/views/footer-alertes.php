                ...
                <table bgcolor="43637c" border="0" width="600" cellpadding="0" cellspacing="0" class="container" align="center">
                	...
                	<tr bgcolor="43637c">
                		<td align="center" mc:edit="copy1" style="color: #d9e6ef; font-size: 13px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" class="prefooter-header">	                			                	Ceci est une alerte email de <a style="color: #fff;" href="<?php echo $home; ?>">www.droitpraticien.ch</a>
                		</td>
                	</tr>
